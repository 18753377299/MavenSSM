...
delete from riskdcode where codetype in ('riskWisdomTree020','riskWisdomTree021','riskWisdomTree022','riskWisdomTree023','riskWisdomTree024','riskWisdomTree025');
...
('riskWisdomTree020', '1', '03', null, '缺陷描述', '6.1', '缺陷追踪中缺陷描述照片', '1'),
...
('riskWisdomTree025', '1', '01', null, '形象进度', '1.1', '项目基本概况中形象进度照片', '1'),
('riskWisdomTree025', '1', '02', null, '整改前图片', '3.1', '前期缺陷追踪整改前图片', '1'),
('riskWisdomTree025', '1', '03', null, '整改后图片', '3.2', '前期缺陷追踪整改后图片', '1'),
('riskWisdomTree025', '1', '04', null, '缺陷描述', '6.1', '本次查勘缺陷清单中缺陷描述照片', '1');
