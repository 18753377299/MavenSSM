...
CREATE TABLE RISKREPORT_DUMPMINE (
	...
	businessLicense CHARACTER VARYING(10),
	businessInfo CHARACTER VARYING(10),
	dumpingLevel CHARACTER VARYING(10),
	dumpingStatus CHARACTER VARYING(10),
	businessRisk CHARACTER VARYING(10),
	safeManageSystem CHARACTER VARYING(10),
	safeManageinstitution CHARACTER VARYING(10),
	contractorManageSys CHARACTER VARYING(10),
	dangerGovernanceSys CHARACTER VARYING(10),
	safeEducationSys CHARACTER VARYING(10),
	specialOperationManageSys CHARACTER VARYING(10),
	specialSafetyManageSys CHARACTER VARYING(10),
	facilityMaintenanceManageSys CHARACTER VARYING(10),
	dangerInvestigationManageSys CHARACTER VARYING(10),
	emergencyPlanDrillSys CHARACTER VARYING(10),
	safeProductionPercentage CHARACTER VARYING(10),
	fireManageSys CHARACTER VARYING(10),
	fireFacilities CHARACTER VARYING(10),
	businessSafeTraining CHARACTER VARYING(10),
	safeProductionAccident CHARACTER VARYING(10),
	safeStandardization CHARACTER VARYING(10),
	dumpingByRequirements CHARACTER VARYING(10),
	safeSignsOtherOperations CHARACTER VARYING(10),
	directDumpingOperation CHARACTER VARYING(10),
	dumpingSiteManagement CHARACTER VARYING(10),
	carGear CHARACTER VARYING(10),
	emergencyEquipmentFacilities CHARACTER VARYING(10),
	monitoringSystem CHARACTER VARYING(10),
	safeClassificationEvaluation CHARACTER VARYING(10),
	dumpingSiteStability CHARACTER VARYING(10),
	floodProtectionFacilities CHARACTER VARYING(10),
	preventMudslides CHARACTER VARYING(10),
	dumpingSafeInspection CHARACTER VARYING(10),
	dumpingMonitoringSystem CHARACTER VARYING(10),
	checkFloodStructures CHARACTER VARYING(10),
	dumpingOutside CHARACTER VARYING(10),
	dumpingInternal CHARACTER VARYING(20),
	majorDangersCriteria CHARACTER VARYING(10),
