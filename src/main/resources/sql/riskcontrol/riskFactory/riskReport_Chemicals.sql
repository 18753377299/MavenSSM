...
-- 	businessMainEquipment CHARACTER VARYING(1),
	...
	CONSTRAINT ck_riskreport_chemicals9 CHECK(dangerGovernanceSys IN  ('','A','B','C')),
	CONSTRAINT ck_riskreport_chemicals10 CHECK(safeEducationSys IN  ('','A','B','C')),
	CONSTRAINT ck_riskreport_chemicals11 CHECK(specialOperationManageSys IN  ('','A','B','C')),
	CONSTRAINT ck_riskreport_chemicals12 CHECK(hotWorkManageSys IN  ('','A','B','C')),
	CONSTRAINT ck_riskreport_chemicals13 CHECK(specialSafetyManageSys IN  ('','A','B','C')),
	CONSTRAINT ck_riskreport_chemicals14 CHECK(facilityMaintenanceManageSys IN  ('','A','B','C')),
	CONSTRAINT ck_riskreport_chemicals15 CHECK(noSmokingManageSys IN  ('','A','B','C')),
	CONSTRAINT ck_riskreport_chemicals16 CHECK(emergencyPlanDrillSyshighly IN  ('','A','B','C')),
	CONSTRAINT ck_riskreport_chemicals17 CHECK(emergencyPlanDrillSysgeneral IN  ('','A','B','C')),
