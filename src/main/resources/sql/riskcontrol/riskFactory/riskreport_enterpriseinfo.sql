...
CREATE TABLE riskreport_enterpriseinfo
    (
        ...
        designscalendec NUMERIC(255,4),       
        actualyielddec NUMERIC(255,4),
        surplusyielddec NUMERIC(255,4),
        saleslastydec NUMERIC(255,4),
        profitlastydec NUMERIC(255,4),
        investmentlastydec NUMERIC(255,4),
        currentheightdec NUMERIC(255,4),
        miningdepthdec NUMERIC(255,4),
        designminingdeptdec NUMERIC(255,4),
        areacovereddec NUMERIC(255,4),
        sumcovereddec NUMERIC(255,4),
        productioncovereddec NUMERIC(255,4),
        workcovereddec NUMERIC(255,4),
        othercovereddec NUMERIC(255,4),
        worddaysyeardec NUMERIC(255,4),
        worksumhoursdec NUMERIC(255,4),
        checkdayesdec NUMERIC(255,4),
        designcapacitydec NUMERIC(255,4),
        actualycapacitydec NUMERIC(255,4),
        surpluscapacitydec NUMERIC(255,4),
        usedcapacitydec NUMERIC(255,4),
        designstockdec NUMERIC(255,4),
        actualystockdec NUMERIC(255,4),
        surplusstockdec NUMERIC(255,4),
        usedstockdec NUMERIC(255,4),
        designproductdec NUMERIC(255,4),
        actualyproductdec NUMERIC(255,4),
        surplusproductdec NUMERIC(255,4),
        usednproductdec NUMERIC(255,4),
        othercapacitydec NUMERIC(255,4),
       minestoretypesel CHARACTER VARYING(1),
        minefloodtypesel CHARACTER VARYING(1),
        isonlinesupervisel CHARACTER VARYING(1),
        isallonlinesuperviseoksel CHARACTER VARYING(1),
        operatingstatusel CHARACTER VARYING(1),
        extensiondate DATE,
        signdate DATE,
        validitydate DATE,
        invaliddate DATE,
        ...
        sumemployeecount INTEGER,
        prodessionemployeecount INTEGER,
        midemployeecount INTEGER,
        architectcount INTEGER,
        costengineercount INTEGER,
        safetyofficercout INTEGER,
        firemancount INTEGER,
        safetymanangercount INTEGER,
        asafeconductcount INTEGER,
        bsafeconductcount INTEGER,
        asafeconductcounc INTEGER,
        projectcount INTEGER,
        companytypesel CHARACTER VARYING(1),
        companynaturesel CHARACTER VARYING(100),
        damtypesel CHARACTER VARYING(1),
        exploitationtypesel CHARACTER VARYING(1),
        extensiontypesel CHARACTER VARYING(1),
        composetypesel CHARACTER VARYING(100),
        typeofshippingsel CHARACTER VARYING(1),
        worktypesel CHARACTER VARYING(1),
        dumplevelsel CHARACTER VARYING(1),
        dumpstatesel CHARACTER VARYING(1),
        businesssel CHARACTER VARYING(1),
        issafetysel CHARACTER VARYING(1),
        isregistersel CHARACTER VARYING(1),
        islistsel CHARACTER VARYING(1),
        mineclasslevelsel CHARACTER VARYING(1),
        damearlytypesel CHARACTER VARYING(1),
        damearlykindsel CHARACTER VARYING(1),
        damfoundationsel CHARACTER VARYING(1),
        validstatus CHARACTER VARYING(1) NOT NULL,
...
ALTER TABLE  riskreport_enterpriseinfo  ALTER COLUMN   companynaturesel   TYPE CHARACTER VARYING(100);
