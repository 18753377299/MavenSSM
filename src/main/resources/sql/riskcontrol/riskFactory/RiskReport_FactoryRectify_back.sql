...
CREATE TABLE RiskReport_FactoryRectify (
        ...
        rectify_column_Name CHARACTER VARYING(50) NOT NULL,
		...
		CONSTRAINT pk_RiskReport_FactoryRectify PRIMARY KEY (risk_File_No,rectify_column_Name)
);
...
--将整改序号改为整改字段名称
comment on column RiskReport_FactoryRectify.rectify_column_Name is '整改字段名称';
